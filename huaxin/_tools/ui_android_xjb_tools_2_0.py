...
from huaxin_ui.ui_android_xjb_2_0.main_page import MainPage

from _common.data_base import DataBase


class AndroidXjbTools20(object):
    ...
    def redeem_fund_product(self, user_name, login_password, fund_product, amount, trade_password):
        ...
        self.main_page.go_to_assets_page()
        self.main_page.go_to_fund_detail_page()
        self.main_page.redeem_fund_product(fund_product=fund_product, amount=amount, trade_password=trade_password)
    ...
    def spend_points_by_buy_vipproduct_use_product_name(self, user_name, login_password, product_name, amount,
        ...
        self.main_page.buy_high_end_product(product_name=product_name, amount=amount, trade_password=trade_password,points='Y')
    ...
    def spend_points_by_buy_dqb(self,user_name,login_password,dqb_product,dqb_product_amount,trade_password):
        ...
        self.main_page.buy_dqb_product(product_name=dqb_product,amount=dqb_product_amount,trade_password=trade_password,points='Y')
    ...
    # 基金频道--自选基金
    def fund_selected_funds(self,user_name,login_password,fund_product_name,fund_product_code,fund_product_name_2,fund_company,fund_product_code_2):
        self.old_user(user_name=user_name,login_password=login_password)
        self.main_page.go_to_fund_page()
        self.main_page.fund_selected_funds(fund_product_name=fund_product_name,fund_product_code=fund_product_code,fund_product_name_2=fund_product_name_2,
                                           fund_product_code_2=fund_product_code_2,fund_company=fund_company)

    # 基金频道--对比分析
    def  fund_comparasion_and_analysis(self,user_name,login_password,fund_product_code,fund_product_code_2):
         self.old_user(user_name=user_name,login_password=login_password)
         self.main_page.go_to_fund_page()
         self.main_page.fund_comparasion_and_analysis(fund_product_code=fund_product_code,fund_product_code_2=fund_product_code_2)
    ...
    def buy_dqb_use_nonsuperposed_coupon(self,user_name,login_password,product_name,amount,trade_password):
        ...
        self.main_page.go_to_finance_page()
        self.main_page.go_to_dqb_product_list_page()
        self.main_page.buy_dqb_product(product_name=product_name, amount=amount, trade_password=trade_password,nonsuperposed_coupon='Y')
    ...
    # 购买高端使用优惠券(不可叠加)
    def buy_vipproduct_use_nonsuperposed_coupon(self, user_name, login_password, product_name, amount, trade_password):
        self.old_user(user_name=user_name, login_password=login_password)
        self.main_page.go_to_finance_page()
        self.main_page.go_to_high_end_product_list_page()
        self.main_page.buy_high_end_product(product_name=product_name, amount=amount, trade_password=trade_password,
    ...
    # 购买基金使用优惠券(不可叠加)
    def buy_fund_use_nonsuperposed_coupon(self,user_name,login_password,fund_product_name, amount, trade_password, fund_product_code):
        self.old_user(user_name=user_name, login_password=login_password)
        self.main_page.go_to_fund_page()
        self.main_page.go_to_fund_detail_page(fund_product_name=fund_product_name, fund_product_code=fund_product_code)
    ...
    # 购买基金使用优惠券(可叠加)
    def buy_fund_use_superposed_coupon(self, user_name, login_password, fund_product_name, amount,trade_password, fund_product_code):
        self.old_user(user_name=user_name, login_password=login_password)
        self.main_page.go_to_fund_page()
        self.main_page.go_to_fund_detail_page(fund_product_name=fund_product_name,fund_product_code=fund_product_code)
    ...
    # 购买定期宝使用积分+优惠券(不可叠加)
    def buy_dqb_use_points_and_nonsuperposed_coupon(self, user_name, login_password, product_name, amount, trade_password):
        self.old_user(user_name=user_name, login_password=login_password)
        self.main_page.go_to_finance_page()
        self.main_page.go_to_dqb_product_list_page()
        self.main_page.buy_dqb_product(product_name=product_name, amount=amount, trade_password=trade_password,
    ...
    # 购买定期宝使用积分+优惠券(可叠加)
    def buy_dqb_use_points_and_superposed_coupon(self, user_name, login_password, product_name, amount, trade_password):
        self.old_user(user_name=user_name, login_password=login_password)
        self.main_page.go_to_finance_page()
        self.main_page.go_to_dqb_product_list_page()
        self.main_page.buy_dqb_product(product_name=product_name, amount=amount, trade_password=trade_password,
    ...
    def buy_fund_use_points_and_nonsuperposed_coupon(self, user_name, login_password, fund_product_name, amount,
        ...
        self.main_page.go_to_fund_detail_page(fund_product_name=fund_product_name,
                                              fund_product_code=fund_product_code)
        self.main_page.buy_fund_product(amount=amount, trade_password=trade_password, points='Y',nonsuperposed_coupon='Y')

    # 购买基金使用积分+优惠券(可叠加)
    def buy_fund_use_points_and_superposed_coupon(self, user_name, login_password, fund_product_name, amount, trade_password,
                                                    fund_product_code):
        self.old_user(user_name=user_name, login_password=login_password)
        self.main_page.go_to_fund_page()
        self.main_page.go_to_fund_detail_page(fund_product_name=fund_product_name,fund_product_code=fund_product_code)
    ...
    def vipproduct_pledge_repay(self,user_name,login_password,product_name,pledge_repay_amount,trade_password):
        self.old_user(user_name=user_name, login_password=login_password)
        self.main_page.go_to_assets_page()
        self.main_page.pledge_repay(product_name=product_name,trade_password=trade_password)
...
if __name__ == '__main__':
    ...
    # device_id = 'DU2MWW145H002092'  # 华为P7
    # device_id='141d7a62'   # 联想

    port = '4726'
    package_name = 'com.shhxzq.xjb'

    m = AndroidXjbTools20(app_path=app_path, platform_version=platform_version, device_id=device_id, port=port,
    ...
    #                              reserve_quota=user['u2']['reservation_code_reserve_quota'],
    #                              reserve_count=user['u2']['reservation_code_reserve_count'],
    ...
    #                           trade_password=user['u1']['trade_password'],
    #                           dqb_product=user['u1']['dqb_product_3'],)
