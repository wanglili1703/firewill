...
import huaxin_ui.ui_android_xjb_2_0.finance_high_end_page
...
BUY_DQB_SPEND_POINTS = "xpath_//android.widget.TextView[@text='定期宝']/following-sibling::android.widget.TextView[2][@text='去购买']"
...
class AssetsMyPointsDetailPage(PageObject):
    ...
    def spend_points_by_buy_vipproduct_use_product_name(self):
        ...
        page = huaxin_ui.ui_android_xjb_2_0.finance_high_end_page.FinanceHighEndPage(self.web_driver)
    ...
    def spend_points_by_buy_dqb(self):
        ...
        page=huaxin_ui.ui_android_xjb_2_0.finance_dqb_page.FinanceDqbPage(self.web_driver)
