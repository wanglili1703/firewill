...
CATEGORY_TITLE_DQB = "xpath_//android.widget.TextView[@text='定期理财']"
CATEGORY_TITLE_HIGH_END = "xpath_//android.widget.TextView[@text='高端理财']"

CATEGORY_TITLE_HIGH_END_START = "swipe_xpath_//android.widget.TextView[@text='热门']"
CATEGORY_TITLE_HIGH_END_STOP = "swipe_xpath_//android.widget.TextView[@text='高端理财']"
