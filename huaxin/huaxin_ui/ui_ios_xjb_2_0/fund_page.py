...
FUND_PRODUCT_INPUT = "accId_UIASearchBar_(searchField)基金代码/简拼/重仓资产"
FUND_PRODUCT_NAME = "accId_UIAStaticText_%s%s"

REPORT_CONTENT = "accId_UIAStaticText_(titleLabel)"
...
RANKING_INSTITUTION_TYPE = "accId_UIAButton_(UIButton_晨星评级icon_arrowfold_white)"
...
SEARCH_BAR = "accId_UIASearchBar_(searchField)基金代码/简拼/重仓资产"
...
class FundPage(PageObject):
    ...
    # 基金频道--自选基金
    @robot_log
    def fund_selected_funds(self, fund_product_name, fund_product_code, fund_product_name_2, fund_company):
        self.perform_actions(SELECTED_FUNDS,
                             ...
                             BACK_BUTTON,
                             # SELECT_FUNDS_BUTTON,
                             # SEARCH_BAR, fund_product_name,
                             # ADD_SELECT,
                             # SEARCH_BAR, fund_product_name_2,
                             # ADD_SELECT,
                             # CANCEL_2,
                             # MANAGE_SELECTED_FUNDS,
                             # DELETE_SELECTED_FUNDS % fund_product_name_2,
                             # DELETE_COMFIRM,
                             # DELETE_SELECTED_FUNDS % fund_product_name,
                             # DELETE_COMFIRM,
                             # DELETE_COMPLETE,
                             )
