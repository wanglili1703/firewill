...
import huaxin_ui.ui_ios_xjb_3_0.login_page
from _common.xjb_decorator import robot_log

FIND_LOGIN_PASSWORD = "accId_UIAElement_找回登录密码"
MODIFY_LOGIN_PASSWORD = "accId_UIAElement_修改登录密码"
CURRENT_LOGIN_PASSWORD = "xpathIOS_UIASecureTextField_/AppiumAUT/UIAApplication/UIAWindow/UIASecureTextField"
CURRENT_LOGIN_PASSWORD_CONFIRM = "accId_UIAButton_(UIButton_下一步)"
# SETTING_LOGIN_PASSWORD = "accId_UIASecureTextField_(textField)8-20位字母,数字或符号任意两种组合"
SETTING_LOGIN_PASSWORD = "xpathIOS_UIASecureTextField_/AppiumAUT/UIAApplication/UIAWindow/UIASecureTextField"
# SETTING_LOGIN_PASSWORD_CONFIRM = "accId_UIAButton_下一步"
SETTING_LOGIN_PASSWORD_CONFIRM = "accId_UIAButton_(UIButton_下一步)"
# SETTING_LOGIN_PASSWORD_AGAIN = "accId_UIASecureTextField_(textField)8-20位字母,数字或符号任意两种组合"
SETTING_LOGIN_PASSWORD_AGAIN = "xpathIOS_UIASecureTextField_/UIAApplication/UIAWindow/UIASecureTextField"
SETTING_LOGIN_PASSWORD_AGAIN_CONFIRM = "accId_UIAButton_(UIButton_确认)"
...
class SettingLoginPasswordPage(PageObject):
    ...
    def modify_login_password(self, login_password_old, login_password_new):
        ...
        page = huaxin_ui.ui_ios_xjb_3_0.login_page.LoginPage(self.web_driver)
