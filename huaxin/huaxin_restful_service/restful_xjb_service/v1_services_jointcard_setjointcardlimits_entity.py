...
URL = u'http://%s/V1/services/jointcard/setJointCardLimits'
BODY_DATA = u'{}'
_BODY_DATA = ''
if BODY_DATA:
...
DATA_PATTERN = {"limitType": "1", "limitAmt": "20000.00", "bankCardId": "0000000000100684",
                "timestamp": "1497961460830", "noncestr": "gglcm4cn1dpnmr9i",
                "signature": "FFBBBC100E858A02B31F338AB77C6AD63C6DC85F"}


class V1ServicesJointcardSetjointcardlimitsEntity(BasicTroopServiceEntityHandler):
    """
    ...
    def __init__(self, domain_name=DOMAIN_NAME, token=None, **kwargs):
        super(V1ServicesJointcardSetjointcardlimitsEntity, self).__init__(domain_name=domain_name, url_string=URL,
...
if (__name__ == '__main__'):
    e = V1ServicesJointcardSetjointcardlimitsEntity()
    e.send_request()
