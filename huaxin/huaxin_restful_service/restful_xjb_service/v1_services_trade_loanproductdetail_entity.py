...
URL = u'http://%s/V1/services/trade/loanProductDetail'
BODY_DATA = u'{}'
_BODY_DATA = ''
if BODY_DATA:
...
class V1ServicesTradeLoanproductdetailEntity(BasicTroopServiceEntityHandler):
    ...
    def __init__(self, domain_name=DOMAIN_NAME, token=None, **kwargs):
        super(V1ServicesTradeLoanproductdetailEntity, self).__init__(domain_name=domain_name, url_string=URL,
...
if (__name__ == '__main__'):
    e = V1ServicesTradeLoanproductdetailEntity()
    e.send_request()
