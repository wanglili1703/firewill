...
URL = u'http://%s/V1/services/trade/myLoanList'
BODY_DATA = u'{}'
_BODY_DATA = ''
if BODY_DATA:
...
DATA_PATTERN = {"isHistory": "0", "pageNo": "1", "pageSize": "20", "timestamp": "1499839460819",
                "noncestr": "flfkjcnufrgpo384", "signature": "739A3C9BF93E06EC44BD63E1CC2B9846F294C839"}


class V1ServicesTradeMyloanlistEntity(BasicTroopServiceEntityHandler):
    """
    ...
    def __init__(self, domain_name=DOMAIN_NAME, token=None, **kwargs):
        super(V1ServicesTradeMyloanlistEntity, self).__init__(domain_name=domain_name, url_string=URL,
...
if (__name__ == '__main__'):
    e = V1ServicesTradeMyloanlistEntity()
    e.send_request()
