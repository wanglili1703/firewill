...
URL = u'http://%s/V1/services/trade/getSalaryFinPlan'
BODY_DATA = u'{}'
_BODY_DATA = ''
if BODY_DATA:
...
DATA_PATTERN = {"isHistory": "0", "pageNo": "1", "pageSize": "20", "timestamp": "1501226076589",
                "noncestr": "wivget7wf5lu7u2e", "signature": "16E2815B66B4A214ABE32D4A179D7D83821D0336"}


class V1ServicesTradeGetsalaryfinplanEntity(BasicTroopServiceEntityHandler):
    """
    ...
    def __init__(self, domain_name=DOMAIN_NAME, token=None, **kwargs):
        super(V1ServicesTradeGetsalaryfinplanEntity, self).__init__(domain_name=domain_name, url_string=URL,
...
if (__name__ == '__main__'):
    e = V1ServicesTradeGetsalaryfinplanEntity()
    e.send_request()
