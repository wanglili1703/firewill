...
URL = u'http://%s/V1/services/creditcard/activeCiticJointcardSendMobileCode'
BODY_DATA = u'{}'
_BODY_DATA = ''
if BODY_DATA:
...
DATA_PATTERN = {"mobile": "", "cardNo": "", "brandType": "", "bankNo": "",
                "timestamp": "1497961460830", "noncestr": "gglcm4cn1dpnmr9i",
                "signature": "FFBBBC100E858A02B31F338AB77C6AD63C6DC85F"}


class V1ServicesCreditcardActiveCiticJointcardSendMobileCodeEntity(BasicTroopServiceEntityHandler):
    """
    ...
    def __init__(self, domain_name=DOMAIN_NAME, token=None, **kwargs):
        super(V1ServicesCreditcardActiveCiticJointcardSendMobileCodeEntity, self).__init__(domain_name=domain_name,
                                                                                           url_string=URL,
                                                                                           data=REQUEST_DATA,
...
if (__name__ == '__main__'):
    e = V1ServicesCreditcardActiveCiticJointcardSendMobileCodeEntity()
    e.send_request()
