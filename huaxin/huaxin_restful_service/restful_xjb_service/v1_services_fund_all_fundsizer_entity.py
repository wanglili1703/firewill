...
DATA_PATTERN = {"gradeOrgId": "10668", "gradeLevel": "5", "riseMin": "0", "riseMax": "100", "riseSection": "4",
                "pageNo": "1", "pageSize": "20", "timestamp": "1494985030520", "noncestr": "z6mjivwd50ps7z1t",
                "signature": "80491B44CE7CC8FA21E3FABDE00F0E800650B891"}


class V1ServicesFundAllFundsizerEntity(BasicTroopServiceEntityHandler):
    """
    ...
    def __init__(self, domain_name=DOMAIN_NAME, token=None, **kwargs):
        super(V1ServicesFundAllFundsizerEntity, self).__init__(domain_name=domain_name, url_string=URL, data=REQUEST_DATA,
...
if (__name__ == '__main__'):
    e = V1ServicesFundAllFundsizerEntity()
    e.send_request()
