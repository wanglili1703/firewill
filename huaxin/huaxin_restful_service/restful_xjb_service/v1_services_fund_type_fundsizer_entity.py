...
DATA_PATTERN = {"fundType": "0", "companyId": "157555", "gradeOrgId": "10668", "gradeLevel": "5", "riseMin": "0", "riseMax": "100",
                "riseSection": "4",
                "pageNo": "1", "pageSize": "20", "timestamp": "1494985030520", "noncestr": "z6mjivwd50ps7z1t",
                "signature": "80491B44CE7CC8FA21E3FABDE00F0E800650B891"}


class V1ServicesFundTypeFundsizerEntity(BasicTroopServiceEntityHandler):
    """
    ...
    def __init__(self, domain_name=DOMAIN_NAME, token=None, **kwargs):
        super(V1ServicesFundTypeFundsizerEntity, self).__init__(domain_name=domain_name, url_string=URL, data=REQUEST_DATA,
...
if (__name__ == '__main__'):
    e = V1ServicesFundTypeFundsizerEntity()
    e.send_request()
