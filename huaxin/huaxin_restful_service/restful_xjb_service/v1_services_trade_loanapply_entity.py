...
URL = u'http://%s/V1/services/trade/loanApply'
BODY_DATA = u'{}'
_BODY_DATA = ''
if BODY_DATA:
...
DATA_PATTERN = {"productId": "H9#H90023", "loanAmt": "153", "loanPurpose": "1", "timestamp": "1499915072065",
                "noncestr": "lvnataynn0qwd1n4", "signature": "1907BB77154D395D38E74EE22BC2CCECAACC0D62"}


class V1ServicesTradeLoanapplyEntity(BasicTroopServiceEntityHandler):
    """
    ...
    def __init__(self, domain_name=DOMAIN_NAME, token=None, **kwargs):
        super(V1ServicesTradeLoanapplyEntity, self).__init__(domain_name=domain_name, url_string=URL, data=REQUEST_DATA,
...
if (__name__ == '__main__'):
    e = V1ServicesTradeLoanapplyEntity()
    e.send_request()
