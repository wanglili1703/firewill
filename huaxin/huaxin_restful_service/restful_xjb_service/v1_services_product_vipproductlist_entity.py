...
URL = u'http://%s/V1/services/product/vipProductList?'
BODY_DATA = ''
_BODY_DATA = ''
if BODY_DATA:
    _BODY_DATA = json.loads(BODY_DATA)
QUERY_DATA = u'isHistory=0&pageNo=1&pageSize=20&timestamp=1499304418215&noncestr=7prlpg9dbsnyiaxp&signature=03222BA5B8D4551238AC651C2BFF3D61464D97FD'
METHOD_TYPE = u'get'
CONTENT_TYPE = 'json'
...
class V1ServicesProductVipproductlistEntity(BasicTroopServiceEntityHandler):
    """
    ...
    def __init__(self, domain_name=DOMAIN_NAME, token=None, **kwargs):
        super(V1ServicesProductVipproductlistEntity, self).__init__(domain_name=domain_name, url_string=URL,
...
if (__name__ == '__main__'):
    e = V1ServicesProductVipproductlistEntity()
    e.send_request()
